...
AbstractPane::AbstractPane(float x, float y, std::string title) : Widget(x, y, 0, 22), title(title), marginLeft(5), marginTop(10),
...
bool AbstractPane::notify(Event *e) {
...
bool AbstractPane::contains(float x, float y) {
